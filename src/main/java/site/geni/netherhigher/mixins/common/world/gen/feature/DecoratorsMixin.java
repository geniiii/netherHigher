...
/**
 * @author KJP12
 * @since Dec. 29, 2020 @ 19:42
 **/
@Mixin(ConfiguredFeatures.Decorators.class)
public class DecoratorsMixin {
    /**
     * Sets the default height limit for all features that are at 128 to 256, depending on the mod's configuration
     *
     * FIXME: This is not an optional way of doing this as this can also change new generation along with all the nether-specific stuff.
